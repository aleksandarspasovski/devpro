...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // js form home page, do not use this home file for navbar, make another
...
function createFeeds() {
  ...
  create_dropdown.addEventListener('click', function (e) {
    var event = e.target;
...
function showIcon() {
  ...
  select_el.addEventListener('click', function (e) {
    var e = e.target;
...
__webpack_require__(/*! C:\wamp64\www\devproject\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\devproject\resources\sass\app.scss */"./resources/sass/app.scss");
